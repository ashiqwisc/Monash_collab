...
df_location <- read.csv("~/Desktop/epistemic_analytics/Monash_collab/data/with_comparison.csv") %>%
  filter(modality == "location") %>%
  as.data.frame()

df_dialogue <- read.csv("~/Desktop/epistemic_analytics/Monash_collab/data/with_comparison.csv") %>%
...
# Note: This uses ID and CD. I don't know what they stand for
location_code_cols <- c("collaborate_primary", "independent_primary", "collaborate_secondary", "independent_secondary", "task_distribution", "task_transition", "ID", "CD")
