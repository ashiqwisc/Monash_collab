...
```{r}
# df <- read_excel("data/merged_A_15_individual_7codes_1s.xlsx") %>% as.data.frame()
...
# 
# df <- df[, -c(1)]
# write.csv(df, "data/with_comparison.csv", row.names = FALSE)
# View(df)
```
...
code_cols <- c("collaborate_primary", "independent_primary", "collaborate_secondary", "independent_secondary", "task_distribution", "task_transition", "provision_of_handover_information","info_sharing_and_situ_assess", "escalation", "information_requesting", "responding_to_request", "agreement")
